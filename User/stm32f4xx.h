/**
  ...
  *              - To use or not the peripheralТs drivers in application code(i.e. 
  *                code will be based on direct access to peripheralТs registers 
  ...
  *           - Macros to access peripheralТs registers hardware
  *  
  ******************************************************************************
  * @attention
  *
