...
#define MPU_SAMPLE_RATE_REG		0X19	//�Լ�Ĵ���Y
#define MPU_SELF_TESTZ_REG		0X0F	//�Լ�Ĵ���Z
#define MPU_SELF_TESTA_REG		0X10	//�Լ�Ĵ���A
...
extern OS_Q     MPU6050_Data_Queue;            // Data queue for inter-task communication
extern OS_SEM   MPU6050_Data_Ready_Sem;        // Signal new data available
